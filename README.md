# ⚔️ FMS - フェンシングマネージャーシステム

フェンシング大会のプール戦＆トーナメント戦＆団体戦を一括管理するWebアプリ。
URL一つで運営も観客もアクセスできます。

## ⚠️ 利用規約（重要）

**本システムの著作権は尾上正幸に帰属します。** 詳細は `LICENSE` をご確認ください。

| 利用シーン | 可否 |
|---|---|
| 個人の学習・研究 | ✅ 自由 |
| 学校・部活動・地域クラブでの教育目的 | ✅ 自由 |
| 非営利のフェンシング大会・練習会 | ✅ 自由 |
| 商用利用（営利目的） | ❌ 要事前許諾 |
| 第三者への有償提供・販売 | ❌ 要事前許諾 |
| 派生製品の作成・配布 | ❌ 要事前許諾 |

商用利用などのお問い合わせは `gyouseihou416@gmail.com` まで。
...
カスタムライセンス（All Rights Reserved）。
個人・教育・非営利の用途は無償で自由に利用できますが、商用利用および再配布には事前許諾が必要です。
詳細は `LICENSE` ファイルをご確認ください。

## 機能一覧

- 個人戦：プール戦＋トーナメント
- 団体戦：紅白戦（5本×9試合の勝数）／イタリアンリレー方式（45本累積）
- プール／トーナメント方式の選択
- 延長戦（タイブレーク）対応
- リアルタイム観戦（Firebase）／オフライン運用（localStorage）
- QRコード生成、JSONバックアップ・復元
- SVGトーナメントブラケット視覚化
